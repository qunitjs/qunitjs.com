...
<p class="lead lead--center">v2.14.1 (<a href="https://github.com/qunitjs/qunit/blob/2.14.1/History.md">changelog</a>)</p>
...
* CDN: [`qunit-2.14.1.js`](https://code.jquery.com/qunit/qunit-2.14.1.js) and [`qunit-2.14.1.css`](https://code.jquery.com/qunit/qunit-2.14.1.css)
