...
<p class="lead lead--center">v2.15.0 (<a href="https://github.com/qunitjs/qunit/blob/2.15.0/History.md">changelog</a>)</p>
...
* CDN: [`qunit-2.15.0.js`](https://code.jquery.com/qunit/qunit-2.15.0.js) and [`qunit-2.15.0.css`](https://code.jquery.com/qunit/qunit-2.15.0.css)
