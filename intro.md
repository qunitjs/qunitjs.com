...
* Download:
  ...
  QUnit has no runtime dependencies for browser use. You can save the [`qunit-2.18.1.js`](https://code.jquery.com/qunit/qunit-2.18.1.js) and [`qunit-2.18.1.css`](https://code.jquery.com/qunit/qunit-2.18.1.css) files directly from the [jQuery CDN](https://code.jquery.com/qunit/), which is powered by [StackPath](https://www.stackpath.com/).

  Or download them via the terminal:

  ```bash
  curl -o qunit.css 'https://code.jquery.com/qunit/qunit-2.18.1.css'
  curl -o qunit.js 'https://code.jquery.com/qunit/qunit-2.18.1.js'
  ```
