...
* Download:
  ...
  QUnit has no runtime dependencies for browser use. You can save the [`qunit-2.14.1.js`](https://code.jquery.com/qunit/qunit-2.14.1.js) and [`qunit-2.14.1.css`](https://code.jquery.com/qunit/qunit-2.14.1.css) files directly from the [jQuery CDN](https://code.jquery.com/qunit/), which is hosted by [MaxCDN](https://www.maxcdn.com/).

  Download them from your terminal:

  ```bash
  curl -O 'https://code.jquery.com/qunit/qunit-2.14.1.{js,css}'
  ```
